...
![Templates screen — select Upload Component to get started](/images/upload/upload-templates.png)
...
<Tabs>
  <Tab title="Path 1 — Upload First (Primary)">
    ...
    {/* [ gap — screenshot of product page with customer photo loaded inside the frame ] */}
