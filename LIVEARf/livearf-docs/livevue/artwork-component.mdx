...
sidebarTitle: "Artwork Component"
...
The Artwork Component lets you offer customers a **live, interactive framing experience** directly on your product page. They can select size, frame style, and mat options — and see the artwork update in real time before buying.
...
<Info>
  Customers cannot upload their own photos in the Artwork Component. For customer uploads, see the [Upload Component](/livevue/upload-component).
</Info>
...
![Component header — Component Name, Image Upload toggle, Quick Setup Guide, and Component Status](/images/artwork/component-header.png)
